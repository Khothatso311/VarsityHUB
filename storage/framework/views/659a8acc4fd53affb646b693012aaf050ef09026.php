...
<div class="row s-hero__content">
    <div class="column">
         <?php $__currentLoopData = $school; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		 <?php if($sch->user_id == Auth::user()->id): ?>
        <h1><?php echo e($sch->name); ?></h1>
	    
        <div class="s-hero__content-about">

            <p>
			<?php echo e($sch->description); ?>

            </p>
			<?php endif; ?>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
 
   <a href="<?php echo e(url('/varsityProfile')); ?>" class="btn btn--primary btn--small" style="float:left;">
...
<table class="table" style="float: left;">
        ...
        <tbody role="rowgroup">
		<?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<?php if($nb->id == $nm->name_id): ?>
         <tr role="row">
         <td role="cell">
          <?php echo e($nb->name); ?>

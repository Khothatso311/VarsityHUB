...
<form method="POST" id="form" action="<?php echo e(route('register')); ?>" >
...
<br>
<h5><a href="<?php echo e(url('/login')); ?>"><b style="color: #118AB2; text-decoration: underline;">Signin Now</b></a></h5>
</form>

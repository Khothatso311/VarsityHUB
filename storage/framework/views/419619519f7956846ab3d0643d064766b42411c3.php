...
<div class="s-header__content">
    ...
    <nav class="s-header__nav-wrap">
        <ul class="s-header__nav" style="margin-left:20px;">
            ...
            <li><a class="smoothscroll" href="<?php echo e(url('/add')); ?>" title="Intro">Add University |</a></li>
            <li><a class="smoothscroll" href="#hube" title="About">Universities |</a></li>
            <li><a class="smoothscroll" href="<?php echo e(url('/adminProfile')); ?>" title="Services">Profile |</a></li>

...
<form method="POST" id="form" action="<?php echo e(url('applyform')); ?>" >
<?php echo e(csrf_field()); ?>
   ...
   <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <input type="hidden" name="varsity_id"  value="<?php echo e($row->id); ?>">

    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

<input type="hidden" name="name_id"  value="<?php echo e(Auth::user()->id); ?>">
...
<select name="course">
	    ...
	    <option value="<?php echo e($row->course); ?>"><?php echo e($row->course); ?></option>

...
<table class="table" style="float: left;">
        ...
        <tbody role="rowgroup">
         ...
         <tr role="row">
         <td role="cell">
          <?php echo e($docx->name); ?>

         </td>
		 <td role="cell">
          <?php echo e($docx->description); ?>

         </td>
         <td role="row">
          <?php echo e($docx->faculty); ?>


         </td>
           <td role="cell" id="goToMe">
          <?php echo e($docx->course); ?>

           </td>
		    <td role="cell" id="goToMe">
          <?php echo e($docx->qualification); ?>
	   ...
	   <h5>Credits for <?php echo e($docx->course); ?></h5>
         <b><?php echo e($docx->credits); ?></b>
		    <hr>
		 <br>
          <h5>Mathematics requirement</h5>
           <b><?php echo e($docx->maths); ?></b>
		      <hr>
		   <br>
		   <h5>English requirement</h5>
           <b><?php echo e($docx->english); ?></b>
		      <hr>
		   <br>
		   <h5>Admission Opened</h5>
           <b><?php echo e($docx->startDate); ?></b>
		      <hr>
            <br>
			<h5>Admission Due Date</h5>
           <b><?php echo e($docx->endDate); ?></b>
		   <hr>
		   <a href="<?php echo e(url('/addInstitute')); ?>" class="btn btn--small">Add Faculties</a>
            <br><br>

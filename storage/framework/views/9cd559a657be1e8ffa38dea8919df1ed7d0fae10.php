...
<?php if(Auth::guest()): ?>
<a class="btn btn-lg rounded-4 btn-primary btn--small" href="<?php echo e(url('/login')); ?>">Signin Now</button>

<br>
<a href="<?php echo e(url('/register')); ?>"  class="btn btn-lg rounded-4 btn-primary btn--small"><b style="color: #118AB2; text-decoration: underline;">Create new Account</b></a>
<?php else: ?>
<a href="<?php echo e(url('/home')); ?>"  class="btn btn-lg rounded-4 btn-primary btn--small"><b style="color: #118AB2; text-decoration: underline;">Join Us Now</b></a>
<?php endif; ?>
</div>
</div>
...
<div class="row row-y-top">
    ...
    <div class="column large-4 medium-12 s-footer__block--end">
        ...
        <div class="ss-copyright">
            <span>&copy;Copyright VersityHUB <?php echo e($date); ?></span> 

...
<form method="POST" id="form" action="<?php echo e(route('login')); ?>">
<?php echo e(csrf_field()); ?>



<h2 style="float: left;">Signin Now</h2>
...
<br>
<h5><a href="<?php echo e(url('/register')); ?>"><b style="color: #118AB2; text-decoration: underline;">Create new Account</b></a></h5>
</form>

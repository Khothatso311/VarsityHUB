...
<div class="row s-hero__content">
    <div class="column">
        ...
        <div class="s-hero__content-about">
            ...
            <p>
            Review University/Institute in Lesotho, and Information <br>
            of Universities in oder to be in timely Updates.
            </p>
  
   <a href="<?php echo e(url('/studentProfile')); ?>" class="btn btn--primary btn--small" style="float:left;">
...
<table class="table" style="float: left;">
        ...
        <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <td role="cell" id="goToMe">
            <a href="<?php echo e(url('/viewss', $row->id)); ?>" class="btn btn--small">view</a>
           </td>

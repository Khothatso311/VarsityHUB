...
<div class="s-header__content">
    ...
    <nav class="s-header__nav-wrap">
        <ul class="s-header__nav" style="margin-left:20px;">
            ...
            <?php else: ?>
			<li><a class="smoothscroll" href="<?php echo e(url('/varsity')); ?>" title="Intro">Varsity Page |</a></li>
            <li><a class="smoothscroll" href="<?php echo e(url('/addInstitute')); ?>" title="Intro">Add University |</a></li>
            <li><a class="smoothscroll" href="#hube" title="About">Universities |</a></li>
            <li><a class="smoothscroll" href="<?php echo e(url('/varsityProfile')); ?>" title="Services">Profile |</a></li>
			<li><a class="smoothscroll" href="<?php echo e(url('/admission')); ?>" title="Services">Admission |</a></li>

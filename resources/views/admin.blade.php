...
<div class="row s-hero__content">
   ...
   <a href="{{url('/adminProfile')}}" class="btn btn--primary btn--small" style="float:left;">
...
<table class="table" style="float: left;">
        ...
        @foreach($varsity as $row)
         ...
         <td role="cell" id="goToMe">
            <a href="{{url('/view', $row->id)}}" class="btn btn--small">view</a>
           </td>
           <td role="cell" id="goToMe">
           <a href="{{url('/delete', $row->id)}}" class="btn btn--small">Delete</a>
           </td>
         </tr>
         @endforeach
        </tbody>

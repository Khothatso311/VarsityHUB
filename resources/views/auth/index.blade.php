...
@if (Auth::guest())
<a class="btn btn-lg rounded-4 btn-primary btn--small" href="{{url('/login')}}">Signin Now</button>

<br>
<a href="{{url('/register')}}"  class="btn btn-lg rounded-4 btn-primary btn--small"><b style="color: #118AB2; text-decoration: underline;">Create new Account</b></a>
@else
<a href="{{url('/home')}}"  class="btn btn-lg rounded-4 btn-primary btn--small"><b style="color: #118AB2; text-decoration: underline;">Join Us Now</b></a>
@endif
</div>
</div>
...
<div class="row row-y-top">
    ...
    <div class="column large-4 medium-12 s-footer__block--end">
        ...
        <div class="ss-copyright">
            <span>&copy;Copyright VersityHUB {{$date}}</span> 

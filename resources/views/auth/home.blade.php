...
<ul>
  <li>
    <a href="{{url('/admin')}}" class="btn btn-lg rounded-4 btn-primary btn--small" >Join As Admin</a>
  </li>
  <li>
  <a href="{{url('/varsity')}}" class="btn btn-lg rounded-4 btn-primary btn--small" >Join As University</a>
  </li>
  <li>
    <a href="{{url('/student')}}" class="btn btn-lg rounded-4 btn-primary btn--small" >Join As Student</a>
  </li>
</ul>

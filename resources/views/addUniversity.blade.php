...
@endif
   ...
   <a href="{{url('/varsity')}}" class="btn btn--primary btn--small" style="float:left;">
...
<form method="POST" id="form" action="{{ url('/addUniversity') }}" >
{{ csrf_field() }}
...
<div class="form-group{{ $errors->has('endtDate') ? ' has-error' : '' }}">
